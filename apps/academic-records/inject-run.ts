...
import { injectAcademicHighlights } from "@pytorch-fit/domain-server/academic-records";
import type { AcademicSnapshot } from "@pytorch-fit/domain-protocol/career-evidence";
