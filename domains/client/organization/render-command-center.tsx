...
import { ActivityTrendChart, CareerReadinessDonut, DepartmentLoadChart, SkillRadarChart } from "@pytorch-fit/domain-client/organization";
import { KanbanBoard } from "@pytorch-fit/domain-client/organization";
...
import type { AnalyticsState, DashboardAnalytics, ProductViewData } from "@pytorch-fit/domain-protocol/career-evidence";
...
import { cn, formatRank } from "@pytorch-fit/design-system/merge-classes";
...
function CareerWorkspace({ data }: { data: ProductViewData }) {
  ...
  const segments = [
    ...
    { label: "Market", ready: manifest.capabilities.opportunities_read.state !== "locked" },
