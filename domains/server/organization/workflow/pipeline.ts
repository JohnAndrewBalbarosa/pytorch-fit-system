import type { IntakeSubmission, GeneratedDocument } from "@pytorch-fit/domain-protocol/organization/workflow";
...
export interface OrgOpsPipelineDeps {
  ...
  defaultDepartments: import("@pytorch-fit/domain-protocol/organization/workflow").Department[];
}
