...
import type { EvidenceItem, EvidenceSource } from "./contracts";
import { configuredProductProvider } from "./repository";
import { createLocalEvidence, saveLocalEvidence, saveLocalMedia, saveLocalSourceState } from "./local-career-store";
import { supportedSourceById } from "./source-catalog";
