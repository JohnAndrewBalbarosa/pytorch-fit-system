  ...
  return (
    <AppShell>
      <div className="space-y-4">
        <section className="rounded-2xl border border-white/10 bg-[#141416] p-5 lg:p-7" data-testid="member-dashboard">
