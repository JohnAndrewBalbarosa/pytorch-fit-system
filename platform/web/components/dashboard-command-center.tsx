...
function fallbackData(): ProductViewData {
  return {
    meta: { source: "live", provider: "local", generatedAt: new Date().toISOString(), label: "Connecting" },
